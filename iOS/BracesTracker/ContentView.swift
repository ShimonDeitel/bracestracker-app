...
struct ContentView: View {
    ...
    @State private var editingEntry: UpdateEntry?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Braces Tracker")
            .toolbar {
    ...
    @ViewBuilder
    private func row(_ entry: UpdateEntry) -> some View {
...
struct EntrySheet: View {
    ...
    @State private var tag: String = BracesTrackerTags.all.first ?? ""
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle(entry == nil ? "New Update" : "Edit Update")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        let t = title.isEmpty ? "Update" : title
