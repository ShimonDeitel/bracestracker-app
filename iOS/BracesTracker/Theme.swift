...
/// Braces Tracker's identity: a palette built specifically for this app's domain
/// (update tracking) - not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.933, green: 0.965, blue: 0.969)
    static let card = Color.white
    static let cardBorder = Color(red: 0.204, green: 0.596, blue: 0.706).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 0.204, green: 0.596, blue: 0.706)
    static let accentDeep = Color(red: 0.133, green: 0.427, blue: 0.51)
